...
IUSE="alsa debug +hibernate-script ntp video_cards_intel video_cards_radeon"
...
src_install() {
	...
	if use hibernate-script; then 
		exeinto /usr/lib64/pm-utils/module.d
		doexe "${FILESDIR}"/hibernate-script
	fi
